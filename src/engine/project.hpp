...
namespace Project
{
    ...
    constexpr uint8 const ENGINE_VERSION_MAJOR_NUMBER = 0;
    /// @brief Minor version number of the engine
    constexpr uint8 const ENGINE_VERSION_MINOR_NUMBER = 1;
    /// @brief Bug fix version number of the engine
    constexpr uint8 const ENGINE_VERSION_BUGFIX_NUMBER = 1;
    ...
    const uint32 ENGINE_MAX_FRAMES_IN_FLIGHT = 3;
