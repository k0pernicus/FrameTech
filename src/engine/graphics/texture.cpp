...
frametech::Texture::Texture(const std::string& filename) : m_tag(filename) {
}

ftstd::VResult frametech::Texture::setup(
	...
	const bool is_1D_texture = texture_type == frametech::Texture::Type::T1D;
...
inline int frametech::Texture::getTextureSize() const noexcept {
